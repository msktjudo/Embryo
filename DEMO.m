...
write_txt(Result{1}.G(:),num2str(cv,'./output/test/CPU/cv%d/G.txt'));
% for i = 1:24
%     write_map(Result{1}.InfoG{i},num2str(i,strcat('./output/test/CPU/cv',num2str(cv),'/InfoG%03d.txt')));
% end
% write_txt(Result{1}.S(:),num2str(cv,'./output/test/CPU/cv%d/S.txt'));
% for i=1:1000
%     write_map(Result{1}.InfoS{i},num2str(i,strcat('./output/test/CPU/cv',num2str(cv),'/InfoS%04d.txt')));
% end
